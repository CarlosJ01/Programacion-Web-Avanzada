...
class Productos extends Seeder
{
    ...
    public function run()
    {
        ...
        $nuevoProducto->imagen = '/imagenes/productos/monitores/07.jpg';
        $nuevoProducto->inventario = 33;
        ...
        $nuevoProducto->imagen = '/imagenes/productos/monitores/01.jpg';
        $nuevoProducto->inventario = 26;
        $nuevoProducto->idCategoria = 1;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/monitores/02.jpg';
        $nuevoProducto->inventario = 136;
        $nuevoProducto->idCategoria = 1;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/monitores/03.jpg';
        $nuevoProducto->inventario = 406;
        $nuevoProducto->idCategoria = 1;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/monitores/04.jpg';
        $nuevoProducto->inventario = 80;
        $nuevoProducto->idCategoria = 1;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/monitores/05.jpg';
        $nuevoProducto->inventario = 88;
        $nuevoProducto->idCategoria = 1;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/monitores/06.jpg';
        $nuevoProducto->inventario = 17;
        $nuevoProducto->idCategoria = 1;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/memorias/01.jpg';
        $nuevoProducto->inventario = 13;
        $nuevoProducto->idCategoria = 2;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/memorias/02.jpg';
        $nuevoProducto->inventario = 1;
        $nuevoProducto->idCategoria = 2;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/memorias/03.jpg';
        $nuevoProducto->inventario = 1;
        $nuevoProducto->idCategoria = 2;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/memorias/04.jpg';
        $nuevoProducto->inventario = 152;
        $nuevoProducto->idCategoria = 2;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/memorias/05.jpg';
        $nuevoProducto->inventario = 12;
        $nuevoProducto->idCategoria = 2;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/memorias/06.jpg';
        $nuevoProducto->inventario = 1;
        $nuevoProducto->idCategoria = 2;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/memorias/07.jpg';
        $nuevoProducto->inventario = 1;
        $nuevoProducto->idCategoria = 2;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/memorias/08.jpg';
        $nuevoProducto->inventario = 13;
        $nuevoProducto->idCategoria = 2;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/procesadoresGraficas/01.jpg';
        $nuevoProducto->inventario = 3;
        $nuevoProducto->idCategoria = 3;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/procesadoresGraficas/02.jpg';
        $nuevoProducto->inventario = 4;
        $nuevoProducto->idCategoria = 3;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/procesadoresGraficas/03.jpg';
        $nuevoProducto->inventario = 1;
        $nuevoProducto->idCategoria = 3;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/procesadoresGraficas/04.jpg';
        $nuevoProducto->inventario = 1;
        $nuevoProducto->idCategoria = 3;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/procesadoresGraficas/05.jpg';
        $nuevoProducto->inventario = 2;
        $nuevoProducto->idCategoria = 3;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/procesadoresGraficas/06.jpg';
        $nuevoProducto->inventario = 5;
        $nuevoProducto->idCategoria = 3;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/procesadoresGraficas/07.jpg';
        $nuevoProducto->inventario = 8;
        $nuevoProducto->idCategoria = 3;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/perifericos/01.jpg';
        $nuevoProducto->inventario = 82;
        $nuevoProducto->idCategoria = 4;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/perifericos/02.jpg';
        $nuevoProducto->inventario = 4;
        $nuevoProducto->idCategoria = 4;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/perifericos/03.jpg';
        $nuevoProducto->inventario = 7;
        $nuevoProducto->idCategoria = 4;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/perifericos/04.jpg';
        $nuevoProducto->inventario = 2;
        $nuevoProducto->idCategoria = 4;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/perifericos/05.jpg';
        $nuevoProducto->inventario = 4;
        $nuevoProducto->idCategoria = 4;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/perifericos/06.png';
        $nuevoProducto->inventario = 9;
        $nuevoProducto->idCategoria = 4;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/perifericos/07.jpg';
        $nuevoProducto->inventario = 12;
        $nuevoProducto->idCategoria = 4;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/perifericos/08.jpg';
        $nuevoProducto->inventario = 33;
        $nuevoProducto->idCategoria = 4;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/perifericos/09.jpg';
        $nuevoProducto->inventario = 1;
        $nuevoProducto->idCategoria = 4;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/perifericos/10.png';
        $nuevoProducto->inventario = 8;
        $nuevoProducto->idCategoria = 4;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/laptop/01.jpg';
        $nuevoProducto->inventario = 11;
        $nuevoProducto->idCategoria = 5;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/laptop/02.png';
        $nuevoProducto->inventario = 2;
        $nuevoProducto->idCategoria = 5;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/laptop/03.jpg';
        $nuevoProducto->inventario = 30;
        $nuevoProducto->idCategoria = 5;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/laptop/04.jpg';
        $nuevoProducto->inventario = 1;
        $nuevoProducto->idCategoria = 5;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/laptop/05.jpg';
        $nuevoProducto->inventario = 9;
        $nuevoProducto->idCategoria = 5;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/laptop/06.jpg';
        $nuevoProducto->inventario = 97;
        $nuevoProducto->idCategoria = 5;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/laptop/07.jpg';
        $nuevoProducto->inventario = 5;
        $nuevoProducto->idCategoria = 5;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/componentes/01.jpg';
        $nuevoProducto->inventario = 1;
        $nuevoProducto->idCategoria = 6;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/componentes/02.jpg';
        $nuevoProducto->inventario = 14;
        $nuevoProducto->idCategoria = 6;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/componentes/03.jpg';
        $nuevoProducto->inventario = 82;
        $nuevoProducto->idCategoria = 6;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/componentes/04.jpg';
        $nuevoProducto->inventario = 33;
        $nuevoProducto->idCategoria = 6;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/componentes/05.jpg';
        $nuevoProducto->inventario = 82;
        $nuevoProducto->idCategoria = 6;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/componentes/06.jpg';
        $nuevoProducto->inventario = 496;
        $nuevoProducto->idCategoria = 6;
        $nuevoProducto->save();
        ...
        $nuevoProducto->precio = '699.48';
        $nuevoProducto->imagen = '/imagenes/productos/componentes/07.jpg';
        $nuevoProducto->inventario = 1;
        $nuevoProducto->idCategoria = 6;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/componentes/08.jpg';
        $nuevoProducto->inventario = 2;
        $nuevoProducto->idCategoria = 6;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/componentes/09.jpg';
        $nuevoProducto->inventario = 7;
        $nuevoProducto->idCategoria = 6;
        $nuevoProducto->save();
        ...
        $nuevoProducto->imagen = '/imagenes/productos/componentes/10.jpg';
        $nuevoProducto->inventario = 84;
        $nuevoProducto->idCategoria = 6;
        $nuevoProducto->save();
    }
}
